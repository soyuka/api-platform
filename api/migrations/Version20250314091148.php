 ...
 */
final class Version20250314091148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, review VARCHAR(255) NOT NULL, book_id INT NOT NULL, PRIMARY KEY(id))');
